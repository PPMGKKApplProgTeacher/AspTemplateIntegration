...
namespace ApartmentsListingDemo.Controllers
{
    public class ListingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Image,Title,Agent,Rent,Size,Bedrooms,Bathrooms")] Listing listing)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Image,Title,Agent,Rent,Size,Bedrooms,Bathrooms")] Listing listing)
        {
            if (id != listing.id)
            {
                return NotFound();
